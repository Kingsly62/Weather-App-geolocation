...
This is a  javascript project made with the help of HTML, CSS and OpenWeather API .Applied weather API to fetch data and display according to the city entered in the search bar.
